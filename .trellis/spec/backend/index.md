...
|-------|-------------|--------|
| [Codex Wire Protocol](./codex-wire-protocol.md) | CCBR ask delivery and Codex JSONL completion contracts | Active |
| [Project Focus Wire Protocol](./project-focus-wire-protocol.md) | ccbrd focus handlers and tmux target selection used by the sidebar | Active |
