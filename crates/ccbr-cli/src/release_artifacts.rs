...
///
/// For Linux: returns "ccbr-linux-{arch}"
/// For macOS: returns "ccbr-macos-universal"
/// Returns None for unknown platforms.
pub fn release_artifact_basename(platform_name: &str, machine: &str) -> Option<String> {
    ...
    match platform.as_str() {
        ...
        "macos" => Some("ccbr-macos-universal".to_string()),
        _ => None,
    }
}
...
mod tests {
    ...
    fn test_release_artifact_basename() {
        ...
        assert_eq!(
            ...
            Some("ccbr-linux-x86_64".to_string())
        );
        assert_eq!(
        ...
        assert_eq!(
            ...
            Some("ccbr-linux-aarch64".to_string())
        );

        // macOS artifact
        assert_eq!(
            release_artifact_basename("Darwin", "x86_64"),
            Some("ccbr-macos-universal".to_string())
        );
        assert_eq!(
    ...
    fn test_release_artifact_name() {
        ...
        assert_eq!(
            ...
            Some("ccbr-linux-x86_64.tar.gz".to_string())
        );
        assert_eq!(
            release_artifact_name("Darwin", "arm64"),
            Some("ccbr-macos-universal.tar.gz".to_string())
        );
