//! Mirrors Python `test/test_ccbr_restart.py` phase2/render subset.
...
use ccbr_cli::models_start::ParsedRestartCommand;
use ccbr_cli::phase2_runtime::dispatch::dispatch;
use ccbr_cli::phase2_runtime::handlers_ops::Phase2Services;
