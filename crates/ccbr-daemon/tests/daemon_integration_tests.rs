...
fn stub_app_with_config(dir: &TempDir, agents: &[&str]) -> CcbdApp {
    ...
    std::fs::write(ccbr_dir.join("ccbr.config"), config).unwrap();
    CcbdApp::with_backend(
        dir.path(),
        StartFlowService::with_stub(),
        StopFlowService::with_stub(),
...
fn test_python_shape_ping() {
    ...
    assert_eq!(resp["target"].as_str(), Some("ccbrd"));
...
fn test_ping_all_targets_shape() {
    ...
    app.registry.register(ccbr_daemon::services::registry::AgentRuntimeEntry {
...
fn test_ack_acknowledges_reply_event() {
    ...
    let envelope = ccbr_mailbox::models::MessageEnvelope {
        ...
        delivery_scope: ccbr_mailbox::models::DeliveryScope::Agent,
        silence_on_success: false,
        route_options: json!({}),
        body_artifact: None,
    };
    let job = ccbr_mailbox::models::JobRecord {
        job_id: "job_test_1".into(),
        submission_id: None,
        agent_name: "claude".into(),
        provider: "claude".into(),
        request: envelope.clone(),
        status: ccbr_mailbox::models::JobStatus::Accepted,
        terminal_decision: None,
        cancel_requested_at: None,
        created_at: "2025-01-01T00:00:00Z".into(),
        updated_at: "2025-01-01T00:00:00Z".into(),
        workspace_path: None,
        target_kind: ccbr_mailbox::models::TargetKind::Agent,
    ...
    completed_job.status = ccbr_mailbox::models::JobStatus::Completed;
    let decision = ccbr_mailbox::facade_recording::CompletionDecision::completed("done");
