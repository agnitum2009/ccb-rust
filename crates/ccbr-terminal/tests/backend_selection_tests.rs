...
use ccbr_terminal::backend_selection::{TerminalBackendSelection, TerminalLayoutService};
use ccbr_terminal::layouts::LayoutResult;
...
fn test_terminal_layout_service_delegates_to_runtime_layout() {
    ...
    assert_eq!(c["detached_session_name"], "ccbr-demo-1");
