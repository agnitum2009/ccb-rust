...
pub use discovery::{
    ...
    find_workspace_binding, global_ccbr_dir, is_dangerous_project_root, load_workspace_binding,
    project_ccbr_dir, ProjectDiscoveryError, WorkspaceBinding,
};
pub use identity::{
    compute_ccbr_project_id, compute_project_id, compute_worktree_scope_id, normalize_project_path,
