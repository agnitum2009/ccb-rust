...
| providers_hook_scripts | `test_provider_finish_hook_script.py` | `tools/ccb-provider-finish-hook/tests/integration_tests.rs` | partial | Standalone finish-hook binary parity for Claude/Gemini Stop/AfterAgent events, empty-reply incomplete marking, and login-required failure detection. |
