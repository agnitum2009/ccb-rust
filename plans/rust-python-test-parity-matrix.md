...
| terminal_runtime | `test_agents_layout_runtime.py`, `test_ccbd_start_runtime_layout.py`, `test_ccbd_tmux_namespace.py`, `test_ccbd_tmux_state.py`, `test_terminal_runtime_backend_env.py` (+19 more) | `crates/ccb-daemon/tests/tmux_runtime_state_tests.rs`, `crates/ccb-terminal/tests/test_backend.rs`, `crates/ccb-terminal/tests/test_layouts.rs`, `crates/ccb-terminal/tests/test_pane_service.rs` (+3 more) | partial | Tmux backend, layouts, and pane registry tests pass (py2rust-terminal). `tmux_runtime.state` pane-state parity mapped to `test_ccbd_tmux_state.py` (py2rust-terminal-state). Remaining namespace/state integration parity deferred to py2rust-daemon. |
