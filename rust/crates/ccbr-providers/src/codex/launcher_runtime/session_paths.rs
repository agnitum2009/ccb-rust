...
pub fn find_project_ccbr_dir(runtime_dir: &Utf8Path) -> Option<Utf8PathBuf> {
    ...
    ccbr_storage::path_helpers::runtime_project_anchor_from_path(runtime_dir)
}
...
mod tests {
    ...
    fn session_file_rejects_invalid_relocated_runtime_marker() {
        ...
        assert!(find_project_ccbr_dir(&runtime_dir).is_none());
