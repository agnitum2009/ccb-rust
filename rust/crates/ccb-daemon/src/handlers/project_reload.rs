...
use ccb_agents::config::{load_project_config, project_config_path};
...
fn current_config_from_registry(app: &CcbdApp) -> ccb_agents::models::ProjectConfig {
    let agents: std::collections::HashMap<String, ccb_agents::models::AgentSpec> = app
        .registry
        .all_entries()
        .iter()
        .map(|e| {
    ...
    let default_agents: Vec<String> = app
        ...
        .collect();
    ccb_agents::models::ProjectConfig {
        version: ccb_agents::models::SCHEMA_VERSION,
        default_agents,
        agents,
        cmd_enabled: false,
        layout_spec: None,
...
fn minimal_agent_spec(name: &str, provider: &str) -> ccb_agents::models::AgentSpec {
    ccb_agents::models::AgentSpec {
        name: name.to_string(),
        provider: provider.to_string(),
        target: name.to_string(),
        workspace_mode: ccb_agents::models::WorkspaceMode::Inplace,
        workspace_root: None,
        runtime_mode: ccb_agents::models::RuntimeMode::PaneBacked,
        ...
        provider_profile: ccb_provider_profiles::ProviderProfileSpec::default(),
