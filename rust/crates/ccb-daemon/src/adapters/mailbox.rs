/// Convert daemon API models to `ccb_mailbox` models.
///
...
use ccb_completion::models::CompletionStatus;
...
) -> ccb_jobs::models::MessageEnvelope {
    ccb_jobs::models::MessageEnvelope {
...
) -> ccb_jobs::models::JobStatus {
    use crate::models::api_models::common::JobStatus as DaemonJobStatus;
    match status {
        DaemonJobStatus::Accepted => ccb_jobs::models::JobStatus::Accepted,
        DaemonJobStatus::Queued | DaemonJobStatus::Running => ccb_jobs::models::JobStatus::Running,
        DaemonJobStatus::Completed => ccb_jobs::models::JobStatus::Completed,
        DaemonJobStatus::Cancelled => ccb_jobs::models::JobStatus::Cancelled,
        DaemonJobStatus::Failed => ccb_jobs::models::JobStatus::Failed,
        DaemonJobStatus::Incomplete => ccb_jobs::models::JobStatus::Incomplete,
    }
}
...
pub fn to_mailbox_completion_decision(
    decision: &ccb_completion::models::CompletionDecision,
) -> ccb_mailbox::facade_recording::CompletionDecision {
    ccb_mailbox::facade_recording::CompletionDecision {
...
fn completion_status_to_mailbox(status: CompletionStatus) -> ccb_jobs::models::JobStatus {
    match status {
        CompletionStatus::Completed => ccb_jobs::models::JobStatus::Completed,
        CompletionStatus::Cancelled => ccb_jobs::models::JobStatus::Cancelled,
        CompletionStatus::Failed => ccb_jobs::models::JobStatus::Failed,
        CompletionStatus::Incomplete => ccb_jobs::models::JobStatus::Incomplete,
    }
}
