...
use ccb_jobs::models::JobRecord;
use ccb_mailbox::models::{InboundEventRecord, ReplyRecord};
use ccb_mailbox::reply_payloads::reply_id_from_payload;
...
mod tests {
    use super::*;
    use ccb_mailbox::models::{InboundEventStatus, InboundEventType, ReplyTerminalStatus};
    ...
    fn test_prepare_agent_reply_delivery_creates_job() {
        let job = JobRecord {
            ...
            status: ccb_jobs::models::JobStatus::Accepted,
            terminal_decision: None,
            cancel_requested_at: None,
            created_at: "t".to_string(),
            updated_at: "t".to_string(),
            workspace_path: None,
            target_kind: ccb_jobs::models::TargetKind::Agent,
