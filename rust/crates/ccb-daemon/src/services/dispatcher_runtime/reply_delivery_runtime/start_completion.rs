...
use ccb_completion::models::CompletionDecision;
use ccb_providers::execution::models::ProviderSubmission;
...
mod tests {
    ...
    use crate::services::dispatcher::JobDispatcher;
    use ccb_completion::models::{CompletionConfidence, CompletionStatus};
    use ccb_providers::execution::models::ProviderSubmission;
