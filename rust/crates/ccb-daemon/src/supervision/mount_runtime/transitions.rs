...
impl From<ccb_terminal::readiness::TmuxTransientServerUnavailable> for MountActionError {
    fn from(err: ccb_terminal::readiness::TmuxTransientServerUnavailable) -> Self {
