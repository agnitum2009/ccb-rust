...
use ccbr_agents::layout::{parse_layout_spec, LayoutLeaf, LayoutNode};
use ccbr_terminal::identity::apply_ccbr_pane_identity;
use ccbr_terminal::placeholders::pane_placeholder_cmd;
use ccbr_terminal::theme::render_tmux_session_theme;
...
mod tests {
    ...
    fn test_request_execute_delegates_to_function() {
        ...
        let context = NamespaceEnsureContext {
            ...
            backend: crate::services::project_namespace_runtime::backend::build_backend(
                ...
                "/tmp/ccbr-topo-test/.ccbr/tmux.sock",
            )
            .unwrap(),
            session_is_alive: false,
            desired_socket_path: "/tmp/ccbr-topo-test/.ccbr/tmux.sock".to_string(),
            desired_session_name: "ccbr-topo-test".to_string(),
    ...
    fn test_topology_recreate_reason_workspace_changed() {
        ...
        let state = crate::services::project_namespace_runtime::models::ProjectNamespaceState {
            project_id: "p1".to_string(),
            namespace_epoch: 1,
            tmux_socket_path: "/tmp/ccbr-topo-test/.ccbr/tmux.sock".to_string(),
            tmux_session_name: "ccbr-topo-test".to_string(),
            layout_version: 1,
