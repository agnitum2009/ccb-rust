...
mod tests {
    ...
    fn test_desired_namespace_state_basic() {
        ...
        assert_eq!(socket, "/tmp/ccbr-test/.ccbr/tmux.sock");
        assert_eq!(session, "ccbr-test");
    ...
    fn test_load_namespace_context_defaults() {
        ...
        assert_eq!(ctx.desired_session_name, "ccbr-test");
    ...
    fn test_load_namespace_context_preserves_recreate_reason() {
        ...
        controller.state_store.namespace = Some(NamespaceState {
            project_id: "p1".to_string(),
            namespace_epoch: 2,
            tmux_socket_path: "/tmp/ccbr-test/.ccbr/tmux.sock".to_string(),
