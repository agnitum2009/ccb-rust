...
) -> ccbr_provider_sessions::files::ProviderClientSpec {
    ccbr_provider_sessions::files::ProviderClientSpec {
...
pub fn resolve_work_dir(
    ...
    ccbr_provider_sessions::resolution::resolve_work_dir(
        &session_spec,
        cli_session_file,
        env_session_file,
        default_cwd,
...
pub fn resolve_work_dir_with_registry(
    ...
    let session_spec = to_session_spec(spec);
    ccbr_provider_sessions::resolution::resolve_work_dir_with_registry(
        &session_spec,
        provider,
        cli_session_file,
        env_session_file,
