...
pub struct StructuredResultSelector {
    base: BaseReplySelector,
}

impl Default for StructuredResultSelector {
    fn default() -> Self {
        Self::new()
    }
}

impl StructuredResultSelector {
    pub fn new() -> Self {
        Self {
...
impl ReplySelector for StructuredResultSelector {
