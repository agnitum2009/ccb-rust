...
use ccb_provider_core::session_binding::binding_status;
...
fn runtime_mode_to_str(mode: ccb_agents::models::RuntimeMode) -> String {
    match mode {
...
fn workspace_mode_to_str(mode: ccb_agents::models::WorkspaceMode) -> String {
    match mode {
        ccb_agents::models::WorkspaceMode::GitWorktree => "git-worktree".into(),
        ccb_agents::models::WorkspaceMode::Copy => "copy".into(),
        ccb_agents::models::WorkspaceMode::Inplace => "inplace".into(),
    }
}
