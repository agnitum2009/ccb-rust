...
use ccb_providers::execution::state_store::ExecutionStateStore;
use ccb_storage::locks::FileLock;
...
fn _pending_job_count(layout: &ccb_storage::paths::PathLayout) -> Result<u64> {
    let mut count: u64 = 0;
