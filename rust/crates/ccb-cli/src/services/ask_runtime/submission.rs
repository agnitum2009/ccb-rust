...
use ccb_agents::models::normalize_agent_name;
use ccb_agents::rolepacks::{looks_like_role_id, normalize_role_id};
use ccb_daemon::models::api_models::common::DeliveryScope;
use ccb_daemon::models::api_models::messages::MessageEnvelope;
use ccb_mailbox::targets::{non_agent_actors, normalize_actor_name};
use ccb_storage::paths::PathLayout;
use ccb_storage::text_artifacts::{
...
where
    ...
    L: FnOnce(&PathLayout) -> ccb_agents::Result<ccb_agents::config::ConfigLoadResult>,
...
fn _validate_target(
    target: &str,
    agents: &std::collections::HashMap<String, ccb_agents::models::AgentSpec>,
) -> anyhow::Result<()> {
