...
use ccb_cli::models::{ParsedCommand, ParsedWaitCommand};
use ccb_cli::services::wait_runtime::service::wait_for_replies;
...
impl ccb_cli::services::wait_runtime::service::TraceClient for FakeTraceClient {
