...
use ccb_provider_core::tmux_ownership::inspect_tmux_pane_ownership;
...
fn test_tmux_ownership_prefers_described_pane_match() {
    ...
    session
        .data
        .insert("ccb_project_id".to_string(), serde_json::json!("proj_1"));
    session
        .data
        .insert("ccb_session_id".to_string(), serde_json::json!("sess_1"));
