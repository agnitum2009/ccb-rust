...
use crate::path_helpers::RootKind;
...
fn scan_layout(layout: &PathLayout) -> crate::Result<Vec<StorageEntry>> {
...
fn scan_identity(path: &Utf8Path) -> crate::Result<(u64, u64)> {
