...
use ccbr_agents::models::{AgentSpec, RuntimeMode};
...
impl CompletionManifestResolver for ccbr_provider_core::catalog::ProviderCatalog {
    fn resolve_completion_manifest(
        &self,
        provider: &str,
        runtime_mode: &RuntimeMode,
    ) -> Result<CompletionManifest> {
        use ccbr_provider_core::manifest::RuntimeMode as CoreRuntimeMode;
