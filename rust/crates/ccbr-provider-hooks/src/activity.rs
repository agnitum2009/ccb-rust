...
pub fn write_activity(
    ...
    let payload = ActivityPayload {
        ...
        ccbr_session_id: optional_text(ccbr_session_id),
...
fn matches_identity(
    ...
    if !optional_matches(payload.get("ccbr_session_id"), ccbr_session_id) {
        return false;
    }
...
fn existing_failed_same_identity(
    ...
    for key in &[
        ...
        let next_text = match *key {
            ...
            "ccbr_session_id" => next_payload.ccbr_session_id.as_deref().unwrap_or(""),
...
mod tests {
    ...
    fn test_failed_activity_is_sticky_until_identity_change() {
        ...
        assert_eq!(payload["ccbr_session_id"], "ccbr-agent2-2");
    }
}
