...
use ccbr_project::runtime_paths::project_registry_dir;
use serde_json::{Map, Value};

pub const REGISTRY_PREFIX: &str = "ccbr-session-";
...
mod tests {
    ...
    fn test_registry_path_for_session() {
        ...
        assert!(s.contains("ccbr-session-abc123.json"));
    ...
    fn test_iter_registry_files_sorted() {
        ...
        assert!(files[0].to_string_lossy().contains("ccbr-session-a.json"));
    }
}
