//! `ccb-provider-activity-hook` — writes CCB provider activity status artifacts.
//!
//! 1:1 port of `bin/ccb-provider-activity-hook` (Python). Invoked as a standalone
...
//! `ccb_provider_hooks::write_activity`.
...
fn main() -> std::process::ExitCode {
    ...
    let ccb_session_id = std::env::var("CCB_SESSION_ID").ok();
