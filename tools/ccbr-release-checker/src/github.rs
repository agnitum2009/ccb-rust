...
pub fn check_readme_surface(
    ...
    if !body.contains(".ccbr/ccbr_memory.md") {
        report.fail(
            format!("{source} {readme_name} does not mention .ccbr/ccbr_memory.md"),
    ...
    if body.contains("CCB.md") {
        report.fail(
            ...
            Some("default-branch README should describe only .ccbr/ccbr_memory.md as current shared memory"),
        );
    }
}
...
"#;
    ...
    #[test]
    fn test_check_readme_surface_ccbr_md_fail() {
